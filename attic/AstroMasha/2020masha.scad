...
for(a=[0:90:360])rotate(a)translate([0,700,0])cube([1420,20,40],center=true);
for(a=[0:90:360])rotate(a)translate([0,725,0])cube([1470,20,40],center=true);
rotate([35,0,0])translate([0,0,-500])rotate([-90,0,0])for(a=[-90:90:90])rotate(a)translate([0,750,0])cube([1500,20,40],center=true);
rotate([-35,0,0])translate([0,0,-500])rotate([-90,0,0])for(a=[-90:90:90])rotate(a)translate([0,750,0])cube([1500,20,40],center=true);
