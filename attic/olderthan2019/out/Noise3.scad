...
randseed=3798753;//rands(0, 49709639, 1)[0]; //global
Resolution =0.5;//[5:5:50] //global
tileX=0;
tileY=0;
MinSubdivisions=3;//[2:1:10] //global
Threshold = 0.45;// [0:0.01:1]
// Allways clamped to powers of two of resolution 
tilesize=20;
// Small Medium Large
octavebalance=[60,100,180];
Zcutoff=5;
Zfalloff=4.2;
Diagnostic=false; //global
colorseed=rands(0, 49709639, 1)[0]; //global
DrawMetaballs( Threshold,tileX*tilesize,tileY*tilesize,-1,tilesize); 
...
function Sweetnoise (x,y,z,seed=69840)=(z-3)/Zfalloff+tril( SC3(x-floor(x)), (SC3(y-floor(y))), (SC3(z-floor(z))),
