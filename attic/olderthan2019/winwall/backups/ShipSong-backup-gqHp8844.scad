...
BottomLine=[
[0,0,0],
[KeelBase*rnd(-0.3,0.3),Beam*rnd(0.1,1.5),1],
[KeelBase*rnd(0.3,0.6),Beam*rnd(0.1,1.5),1],
[KeelBase*rnd(0.6,0.9),Beam*rnd(0.1,1.5),1],
[KeelBase,0,1],
[KeelBase,0,1]];
WaterLine=[
[-Stern*rnd(0,1),0,SternHeight/2],
[-Stern*rnd(0,1),Beam*rnd(0.1,1.5),SternHeight/2],
[KeelBase*Beam*rnd(0.3,0.6),Beam*rnd(0.1,1.5),BeamHeight/2],
[KeelBase+Bow/2,0,BowHeight/2],
[KeelBase+Bow/2,0,BowHeight/2]];
BeamLine=[
[-Stern*rnd(-0.3,1),0,SternHeight],
[-Stern*rnd(-0.3,1),Beam*rnd(0.1,1.5),(BeamHeight+SternHeight)/2],
[KeelBase*rnd(0.0,0.5),Beam*rnd(0.1,1.5),BeamHeight],
[KeelBase*rnd(0.5,0.9),Beam*rnd(0.1,1.5),BeamHeight],
...
difference(){
    ...
    union(){
    Middeck();
    translate(tiny)BoatHull(20,15);
    }
    }
  * render() difference(){
     BoatHull(10,10);
        translate(tiny) BoatHull(-10,15);
           Middeck();
    }       
...
mirrorcopy([0,-1,0]){
    ...
    translate([0,0,0]) scale(3) cube([LOA/200,LOA/100,LOA/300],center=true);
    }  }
    


extrudeT(KeelBow,16,-0.08,1){
