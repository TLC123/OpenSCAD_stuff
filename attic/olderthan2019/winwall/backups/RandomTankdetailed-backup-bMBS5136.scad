...
color("LightGreen",0.5)
    translate([o1,0,0.5])rotate ([0,r1,0])translate([0,0,0.5])
//back_slope
color("Green",0.5) 
...
color("DarkOliveGreen") intersection(){
    ...
    color("Red")
    translate([x(i), y(i),0]) 
    translate([0,4,0])resize([18,8,16])tcube();
    }}
...
hull(){
    ...
    module wheel(){
        ...
        module tcube(){
            difference(){
            cube(center=true,[2,1,1]);
            rotate ([0,0,0])translate([rands(-3,3,1)[0],0,-0.405]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
                
             rotate ([90,0,0])translate([rands(-3,3,1)[0],0,-0.405]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
                 rotate ([180,0,0])translate([rands(-3,3,1)[0],0,-0.405]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
                 rotate ([270,0,0])translate([rands(-3,3,1)[0],0,-0.405]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
            
            
            rotate ([0,90,0])translate([rands(-3,3,1)[0],0,-0.905]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
            
            rotate ([0,270,0])translate([rands(-3,3,1)[0],0,-0.905]) resize([8,1.01,0.1])surface(file = "techtex.png", center = true, convexity = 5,invert=true);
            }}