...
/*[Tank]*/
size=1;//[0.5;2]
// details not rendered in preview
style=1;//[1,2,3,4,5,6]
// bubbly style
bubble=1;//[1:no,2:yes,3:special]
/*[-]*/
...
gund=2.5;//[2:0.1:3.5]
gunelev=10;//[0:35]
gunstyle1=1;//[1:off,2:on]
gunstyle2=1;//[1:off,2:on]
gunstyle3=1;//[1:off,2:on]
/*[Tracks]*/
theight=1;//[0.5:0.01:1.2]
tlengdth=1;//[0.8:0.01:1.4]
twidth=0.8;//[0.5:0.01:3]
tslopeupper=1.4;//[0.1:0.01:1.45]
tslope2=0.1;//[-0.1:0.01:0.3]
tslope3=0.5;//[0.3:0.01:0.7]
tslope1=max(0.65,tslope2+tslope3);
/*[Track Skirt]*/
skirt=2;//[1:off,2:on]
skirtstyle1=2;//[1:off,2:on]
skirtstyle2=2;//[1:off,2:on]
skirtstyle3=0;//[0:off,1:on]
skirtstyle4=2;//[1:off,2:on]
wi= 2;//[1:0.1:7]
bi=15;//[14:0.1:16]
skirtstylero=0;//[-15:30]
/*[hull]*/
B1Xsize=45;//[40:50]
B1Ysize=rnd(B1Xsize*0.5,B1Xsize*.55);//[0.5:0.55]
...
B1r1=45;//[30:45]
B1o1=0.1;//[0.1:0.1:0.21]
B1r2=55;//[55:60] 
B1o2=0.4;//[0.4:0.1:0.5]
B1r3=70;//[60:75] 
B1o3=0.4;//[0.3:0.1:0.45]
B1r4=25;//[0:90] 
B1o4=0.25;//[-1:0.1:1]
B1r5=20;//[0:90]
B1o5=0.25;//[-1:0.1:1]
...
translate([T1Xplace,0,0])rotate([0,0,Rotate]){   
...
color("DarkOliveGreen")hull(){
    ...
    translate([x(i), y(i),0]) 
    translate([0,0,-7.501])cylinder(r=3.3,h=6.2,$fn=8);
    }}
...
for (i = [1.04:0.4:6.04]) {
 ah=0.3;
    ...
    translate([0,-2.5,0])
    rotate([0,0,-ro])
    cube([4,8*theight,15.001],center=true);
