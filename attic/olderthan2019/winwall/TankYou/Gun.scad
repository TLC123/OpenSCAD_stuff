...
B1Ysize=rnd(B1Xsize*0.5,B1Xsize*.65);//[10:100]
...
B2Xsize=rnd(B1Xsize*0.6,B1Xsize*0.9);//[10:100]
B2Ysize=rnd(B2Xsize*0.2,B2Xsize*0.7);//[10:50]
...
rotate([0,0,0]){
color("Red",0.9)translate([B1Xplace, B1Yplace, B1Zplace])resize([B1Xsize, B1Ysize, B1Zsize])	
body(B1r1, B1o1, B1r2, B1o2, B1r3, B1o3, B1r4, B1o4, B1r5, B1o5, B1r6, B1o6, B1r7, B1o7, B1r8, B1o8);

color("Green",0.9)translate([B2Xplace, B2Yplace,B2Zplace])resize([B2Xsize, B2Ysize, B2Zsize])
body(B2r1, B2o1, B2r2, B2o2, B2r3, B2o3, B2r4, B2o4, B2r5, B2o5, B2r6, B2o6, B2r7, B2o7, B2r8, B2o8);

color("Blue",0.9)translate([B3Xplace,B3Yplace,B3Zplace])resize([B3Xsize, B3Ysize, B3Zsize])
...
translate([T1Xplace,0,0])rotate([0,0,0]){   
 ...
 color("Lightgreen") translate([0,T1Yplace,B3Zplace-B2Zsize])  cylinder(d=max(B2Ysize,B3Ysize),h=B2Zsize*2.5);
color("pink",0.9)translate([0, T1Yplace, T1Zplace])resize([T1Xsize, T1Ysize, T1Zsize])	
body(T1r1, T1o1, T1r2, T1o2, T1r3, T1o3, T1r4, T1o4, T1r5, T1o5, T1r6, T1o6, T1r7, T1o7, T1r8, T1o8);

color("Lightgreen",0.9)translate([T2Xplace-T1Xplace, T2Yplace,T2Zplace])resize([T2Xsize, T2Ysize, T2Zsize])
body(T2r1, T2o1, T2r2, T2o2, T2r3, T2o3, T2r4, T2o4, T2r5, T2o5, T2r6, T2o6, T2r7, T2o7, T2r8, T2o8);

color("LightBlue",0.9)translate([T3Xplace-T1Xplace,T3Yplace,T3Zplace])resize([T3Xsize, T3Ysize, T3Zsize])
...
color("LightGreen",0.8)
    translate([o1,0,0.5])rotate ([0,r1,0])translate([0,0.0001,0.5])tcube();
//back_slope
color("Green",0.5) 
    translate([-o2,0,0.5])rotate ([0,-r2,0])translate([0,0,0.5])tcube();
//Front_under_slope
color("DarkGreen",0.5)
    translate([-o3,0,-0.5])rotate ([0,r3,0])translate([0,0.001,-0.5])tcube();
//back_under_slope
color("DarkGreen",0.5) 
...
//Front_right_slope
color("Pink",0.5)
    translate([-o5,0.5,0])rotate ([0,0,r5])translate([0,0.5,0.001])tcube();
//back_right_slope
color("Pink",0.5) 
...
//back_left_slope
color("red",0.5)
    translate([-o8,-0.5,0])rotate([0,0,-r8])translate([0,-0.5,0.001])tcube();
    ...
    rotate ([0,90,0]){
      ...
      ,d*3])cube(1,center=true);
        ...
        difference() {   
           ...
           union(){ 
               if (gunstyle1>1){for(i=[0:6]){   color("Red",0.9) translate([0,0,d*2.9 + i])cylinder(d=d*1.55,l*0.01,$fn=8);     }}
            
            if (gunstyle2>1){color("Blue",0.9)for(i=[0:3]){    rotate([0,0,i*60])translate([0,0,l*0.5])cube([d*1.15,d*0.25,l],center=true);     }}
            if (gunstyle3>1){color("Green",0.9)for(i=[0:2:5]){    translate([0,0,l*1.01- i*1.7])cylinder(d=d*1.55,l*0.08,$fn=8);     }}
            
              color("Yellow",0.9) translate([0,0,0])cylinder(d=d,l,$fn=20);}
...
//skirt
 ...
 intersection(){
    ...
    translate([0,0,0])rotate([0,0,skirtstylero])cube ([wi+0.001,35,bi],center=true);}}
           
    color("Red")hull(){for (i=[2:1:4]){
    translate([x(i), y(i),0]) 
    translate([0,0,-8])cylinder(r=7,h=16,$fn=8);}}
    if(skirtstyle2>1){  
    color("Blue")hull(){for (i=[2:1:4]){
    translate([x(i), y(i),0]) 
    translate([0,0,-7])cylinder(r=8,h=1,$fn=8);}}
    color("Blue") hull(){for (i=[2:1:4]){color("Red")
    translate([x(i), y(i),0]) 
    ...
    module wheel(){
        ...
        module tcube(){resize([2,1.1,1.1])
            ...
            intersection(){
                ...
                translate([rnd(-3,3),0,-0.05]) resize([8.01,1.5,1])strip();
                color("Red",0.9)rotate ([270,0,0])
                translate([rnd(-3,3),0,-0.05]) resize([8.01,1.5,1])strip();
            }
            }
            union(){
               color("Green",0.9)rotate ([0,90,0])
