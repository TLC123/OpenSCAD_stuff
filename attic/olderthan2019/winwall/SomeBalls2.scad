...
function Powerball(x, y, z, Ball) = 
let(d =  [x,y,z] ,r=Ball[3],b=[Ball.x,Ball.y,Ball.z])len3(d-b)-r;

// Recursive Field Evaluation
function BallField3D(x, y, z, BallSack, i) = (i == 0) ? Powerball(x, y, z, BallSack[0]):min( Powerball(x, y, z, BallSack[i]) , BallField3D(x, y, z, BallSack, i - 1));
