...
extrudeT(l4);
extrudeT(l5){
rotate([0,-90,0])linear_extrude(height = 1)scale(0.1)offset(r=1,$fn=20)difference(){
circle(10);
translate([0,5,0])circle(10);
}
};
ShowControl(l6);
}
...
extrudeT(neck,30,0.45,0.95,0,1){//head
scale([0.8,1.2,0.9])hull(){
translate( [0,0.5,0.6])rotate([0,90,0])sphere(0.2);
translate( [0,-0.5,0.4])rotate([0,90,0])sphere(0.2);
translate( [0,-0.5,-0.4])rotate([0,90,0])sphere(0.2);
translate( [0,0.5,-0.6])rotate([0,90,0])sphere(0.2);
}}
extrudeT(neck,30,0.07,0.45,0,1){// neck
hull(){
scale([0.8,1.2,0.9])translate( [0,0.5,0.2])rotate([0,90,0])sphere(0.2);
scale([0.8,1.2,0.9])translate( [0,-0.5,0.4])rotate([0,90,0])sphere(0.2);
scale([0.8,1.2,0.9])translate( [0,-0.5,-0.4])rotate([0,90,0])sphere(0.2);
scale([0.8,1.2,0.9])translate( [0,0.5,-0.2])rotate([0,90,0])sphere(0.2);
}}}
 rotate([0,-90,90])extrudeT(neck2,30,0.09,0.90,0,1){
 hull(){
rotate([0,0,90])sphere(0.5);
}}
*rotate([0,-90,90])extrudeT(l4,30,0.05,0.90,0,1){
 translate([0,0,0.3])rotate([0,0,90])sphere(1);
 translate([0,0,-0.3])rotate([0,0,90])sphere(1);
}}
