...
function relax(points, faces, neighbours, filterv, cell,voxel_treshold , c =  25) = c >
 0 ?
 let (midpoints = [
...
function findp2p(inp, pl, mi, ma,voxel_treshold, f = 50) =
...
len3(df)>0.01?findp2p((p + (df * 0.9)), pl, mi, ma,voxel_treshold,  f - 1) : p:p;
////////////
////////////
////////////
////////////
...
let (v = o - p)  ( (v.x * n.x + v.y * n.y + v.z * n.z)); //proj ap to a plane
