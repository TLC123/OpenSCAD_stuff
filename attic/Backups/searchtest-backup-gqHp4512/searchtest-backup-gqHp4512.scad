...
//Main evaluator
function eval(p,model )= cR3(p,[[4,4,4],0]) ;// minR( torus(p), box(p),1);
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
// testing primitives
...
function cube(p,b)=let(d = abs3(p) - b)
 min( max(d.x,d.y,d.z) ,0.0) + len3(max3(d,0.0)); 
