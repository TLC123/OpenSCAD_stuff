    ...
    union(){
        ...
        n=8;// num faces
          ...
          !  for(loop=[0:loops]){
                    ...
                    r=rands(0,360,l,seed+loop); // NEED TO USE rseed
                    t=rands(90,180,l,seed+loop+1);  // NEED TO USE rseed
                    v21=round(rands(0,l-1,n*3+1,seed+loop));// NEED TO USE rseed
        ...
        translate([0,-people_scale*.65+over*2,-h*2.2])
            scale([r*2,r*0.95,h*2.66-r*0.01+over]){ hull() { polyhedron(v1, v2);}}
        ...
        union(){
            ...
            hull(){
                ...
                translate([rands(-perimiter_diameter ,perimiter_diameter,1,seed)[0],rands(-perimiter_diameter,0,1,seed)[0],-h*2])
