...
/* [Hidden] */
///////////////////////////////////////////////////////////////////////////////
//CC subdivision-ïsh in that regar this impl dont split edges
// uses polyhedrontype data pointlist and face list
// [  [[10,10,10],[10,-10,-10],[-10,10,-10],[-10,-10,10]],    [[2,1,0],[3,2,0],[1,3,0],[2,3,1]]]
// usage cc([points,faces],iterations(0=off),curvebias)
///////////////////////////////////////////////////////////////////////////////
// Demo Code
in=cc(cc(tet(),Sub1),Sub2,-0.5); //one regular and the two passes with negative bias por pointyness
