// source=coordinates form=solid id =HeptagonalDodecahedronA_C3_3
solid_1 = HeptagonalDodecahedronA_C3_3();
p_describe(solid_1);
solid_2 = rcc(solid_1,2);
scale(20) show_solid(solid_2);

function Z() = HeptagonalDodecahedronA_C3_3();
function HeptagonalDodecahedronA_C3_3() = 
// source:  http://dmccooey.com/polyhedra/HeptagonalDodecahedronA_C3_3.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
poly(name = "Heptagonal Dodecahedron (type A) (C3-symmetric form 3)",
// 7 sided faces = 12
vertices = [
[ 6.0,  6.0,  6.0],
[ 0.0,  0.0,  0.0],
