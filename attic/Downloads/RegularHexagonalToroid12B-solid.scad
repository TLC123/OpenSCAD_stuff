// source=coordinates form=solid id =RegularHexagonalToroid12B
solid_1 = RegularHexagonalToroid12B();
p_describe(solid_1);
scale(20) show_solid(solid_1);

function Z() = RegularHexagonalToroid12B();
function RegularHexagonalToroid12B() = 
// source:  http://dmccooey.com/polyhedra/RegularHexagonalToroid12B.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
let(C0 = 1.33333333333333333333333333333)
poly(name = "Regular Hexagonal Toroid with 12 faces (type B)",
// 6 sided faces = 12
vertices = [
[ 6.0,  6.0,  6.0],
[ 6.0,  6.0, -6.0],
