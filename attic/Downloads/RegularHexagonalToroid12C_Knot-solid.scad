// source=coordinates form=solid id =RegularHexagonalToroid12C_Knot
solid_1 = RegularHexagonalToroid12C_Knot();
p_describe(solid_1);
solid_2 = rcc(solid_1,1);
scale(20) show_solid(solid_2);

function Z() = RegularHexagonalToroid12C_Knot();
function RegularHexagonalToroid12C_Knot() = 
// source:  http://dmccooey.com/polyhedra/RegularHexagonalToroid12C_Knot.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
poly(name = "Regular Hexagonal Toroid with 12 faces (type C) (knot form)",
// 6 sided faces = 12
vertices = [
[ 63,  -9,   9],
[-63,  -9,   9],
