...
///*
for (x=[-5:0.25: 5]){for (y=[-5:0.25:5]){
hull(){
translate ([x*10,y*10,0])scale([2,2,15])cube(Noise(x*2 ,y*2 ,1,10));
translate ([x*10+2.5,y*10,0])scale([2,2,15])cube(Noise(x*2+0.5 ,y*2 ,1,10));
translate ([x*10+2.5,y*10+2.5,0])scale([2,2,15])cube(Noise(x*2+0.5 ,y*2+0.5 ,1,10));
translate ([x*10,y*10+2.5,0])scale([2,2,15])cube(Noise(x*2 ,y*2+0.5 ,1,10));}}
}
// end of demo code */
