...
/* [House] */
//dimensions in cm
housex = rnd(400,3000); //[100:3000]
housey = rnd(400,3000); //[100:3000]
housez = rnd(400,500); //[100:3000]
//roof height
roofz = rnd(30,1000); //[30:10000]
//export as plate
asplate =0; //[1,0]
//0=everything
...
/* [Windows and Doors] */
winh = rnd(housez*0.2,housez*0.9); //[10:500]
winw = rnd(40,300); //[10:500]
wind = 20; //[10:30]
winz = 82; //[0:500]
doorh = rnd(housez*0.3,housez); //[10:500]
doorw = rnd(80,500); //[10:500]
doord = 20; //[10:30]
doorz = 0; //[0:500]
//distance from corner to first window
vanpadding = rnd(max(winw,doorw),500); //[0:500]
//spaceing
spacew = rnd(10,500); //[0:500]
//windows and doors order win=1 door=2
WD1 = [dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice()];
WD2 = [dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice()];
WD3 = [dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice()];
WD4 = [dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice(),dice()];
/* [Walls] */
//brick sizes
stoneh = rnd(10,housez*0.1); //[10:1000]
stonew = rnd(10,min(housex,housey)*0.1); //[10:1000]
stoned = rnd(5,50); //[5:50]
bstoneh = rnd(10,housez); //[10:1000]
bstonew = rnd(10,min(housex,housey)); //[10:1000]
bstoned = rnd(5,50); //[5:50]
//round wall tiles
stonetypewall = dice()-1; //[0,1] 
//wall randomnes [0:50)
fr = 0;
/* [Roof] */
// roof over shoot [10:200]
overhang = rnd(10,200);
overhang2 = rnd(10,200);
//rooftile size
roofstoneh = rnd(10,housex*0.1); //[10:1000]
roofstonew = rnd(10,housey*0.1); //[10:1000]
roofstoned = rnd(25,50); //[5:50]
//round roof tiles
stonetype = dice()-1; //[0,1] 
//roof randomness
fr2 = 5;
/* [Chimney] */
//dimensions in cm 
...
chimx = rnd(120,200); //[20:3000]
chimy = rnd(chimx*0.5,chimx*2); //[20:3000]
chimz = rnd(housez+roofz,roofz+housez*3); //[20:3000]
chimofx = rnd(-chimx,housex*0.5); //[-1000:3000]
chimofy = rnd(-housey*0.5,chimy); //[-3000:1000]
// end of settings
		...
		intersection()
		{
			...
			union()
			{
				for (i = [0: length * 2 / stonew])
				{
					...
					resize([bstonew * 1.5, bstoned * 1.5, bstoneh * 1.5]) basestone();
				}
			}
			translate([0, 0, 0])
...
module wall(w, d, h, order)
    ...
    function dice()=floor (rnd(0,2)*0.999999)+1;