...
include <DCmath.scad>
function snapclamp(a)=a==clamp(a)?a:a;
...
//p24=(p2+p4)/2,
//p34=(p3+p4)/2
p12=lerp (p1,p2,snapclamp( abs(e1)/(abs(e1)+abs(e2))) ) ,
p13=lerp (p1,p3,snapclamp(abs(e1)/(abs(e1)+abs(e3)) )),
p14=lerp (p1,p4,snapclamp(abs(e1)/(abs(e1)+abs(e4)) )),
p23=lerp (p2,p3,snapclamp(abs(e2)/(abs(e2)+abs(e3)) )),
p24=lerp (p2,p4,snapclamp(abs(e2)/(abs(e2)+abs(e4)) )),
p34=lerp (p3,p4,snapclamp(abs(e3)/(abs(e3)+abs(e4)) ))
...
//cbpl([
// (meshcellW( [C,p000], scene )),
//(meshcellW( [C,p100], scene )),
//(meshcellW( [C,p010], scene )),
// (meshcellW( [C,p011], scene )),
//(meshcellW( [C,p001], scene )),
// (meshcellW( [C,p110], scene )),
// (meshcellW( [C,p101], scene )),
//(meshcellW( [C,p111], scene ))
//])
...
C = (O + S) / 2, 
D = S - O, maxD = max(abs( D.x), abs(D.y), abs(D.z)) ,
...
// bail early
let(e000=eval(O+[0,0,0],scene)) 
abs(e000)>maxD *2?[[],[]]:
let(e100=eval(O+[D.x,0,0],scene)) 
abs(e100)>maxD *2?[[],[]]: 
let(e010=eval(O+[0,D.y,0],scene)) 
abs(e010)>maxD *2?[[],[]]: 
let(e011=eval(O+[0,D.y,D.z],scene)) 
abs(e011)>maxD *2?[[],[]]: 
let(e001=eval(O+[0,0,D.z],scene)) 
abs(e001)>maxD *2?[[],[]]: 
let(e110=eval(O+[D.x,D.y,0],scene)) 
abs(e110)>maxD *2?[[],[]]: 
let(e101=eval(O+[D.x,0,D.z],scene)) 
abs(e101)>maxD *2?[[],[]]: 
let(e111=eval(O+[D.x,D.y,D.z],scene))
