...
// 1 = square 1x1 ; [1]= square 1x1 ;
// {[1,2]= square 1x2; 
// [[1,1],[2,2]]= square bounded by corners 1,1 and 2,2;
// [[0,0,1]] = circle r=1 at 0,0; 
// [[0,0,1],[1,1,1]]= ywo circles r=1 at 0,0 and 1,1; 
// [[0,0,1],[1,1,1]]= line width=1 from 0,0 to 1,1;
// [[0,0],[10,10],[5,20]]= polygon of those points.
// [[0,0,1],[10,10,1],[5,20,1]]= "polygon" with circles as points .
//******************************************************
...
helpZ=666;
 ...
 intersection(){
 rotate([  0,90,00]) rotate([  0,00,90])linear_extrude(X ,convexity=8) Xplane();
 mirror([0,0,1])rotate([-90, 0,0])linear_extrude(Y ,convexity=8) Yplane();
 mirror([0,0,0])rotate([  0, 0,0])linear_extrude(Z ,convexity=8) Zplane();
}
