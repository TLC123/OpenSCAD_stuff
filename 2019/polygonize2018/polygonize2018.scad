...
cube(p+[0.1,1.1,1],2,0),
max(cube(p-[0.1,1.1,1],2,0),-sphere(p,1)),   
0.001);
// x=-1;y=0;z=1;    
...
sp1=fit([[p1]])[0],
sp2=fit([[p2]])[0],
nsp0=un(evalnorm(sp0)),
nsp1=un(evalnorm(sp1)),
nsp2=un(evalnorm(sp2)),
...
function fit(m)=  
[for(i=m[0])i- un(evalnorm(i))*evalv(i)*1];
...
normalatfmidpoints=[for(i=fittedmidpoints)evalnorm(i)], 
newpoints=[
