...
r8=rnd(0,1)/8;
rsym1=round(rnd(1,6));
rsym2=round(rnd(0,rnd(16)));
msym1=round(rnd(0,rsym1));
msym2=round(rnd(0,rsym2));
rsum=baser+r0+r1+r2+r3+r8;
step=5*rsym1;
d=rnd(360);
e=rnd(-0.1,0.1);
 symmetries(rsym1,msym1){translate([-0.7+0.7/rsym1,0,0])rotate([0,0,d])scale([0.3+0.7/rsym1,e+0.3+0.7/rsym1,1])symmetries(rsym2,msym2){it ();};}
