...
v1 =[   for (t = [0: n])[t*50,0,rnd(50),1]];
v2 =[   for (t = [0: n])[t*50,50,rnd(50),1]];
v3 =[   for (t = [0: n])[t*50,100,rnd(50),1]];
v4 =[   for (t = [0: n])[t*50,150,rnd(50),1]];



spl1=roundlist( v2spl(v1,tension),0.1);
spl2=roundlist( v2spl(v2,tension),0.1);
spl3=roundlist( v2spl(v3,tension),0.1);
spl4=roundlist( v2spl(v4,tension),0.1);

spline(spl1,d=detail,twist=360*turns,gap=gap);
spline(spl2,d=detail,twist=360*turns,gap=gap);
spline(spl3,d=detail,twist=360*turns,gap=gap);
spline(spl4,d=detail,twist=360*turns,gap=gap);

for(i=[0:0.1:1]){
v0=[
spl2(i*len3spl(spl1), spl1),
spl2(i*len3spl(spl2), spl2),
spl2(i*len3spl(spl3), spl3),
spl2(i*len3spl(spl4), spl4)];
spl0=roundlist( v2spl(v0,tension),0.1);
spline(spl0,d=detail,twist=360*turns,gap=gap);
