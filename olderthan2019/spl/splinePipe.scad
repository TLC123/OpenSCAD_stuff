...
v =[   for (t = [0: n])[rnd(-50, 50) + (t - n * 0.5) * 20, rnd(-50, 50), rnd(-50, 50),1 ]];
v2 =[   for (t = [0: n])[v[t][0],v[t][1],v[t][2],2 ]];
spl=roundlist( v2spl(v,tension),0.1);
spl2=roundlist( v2spl(v2,tension),0.1);
difference(){
spline(spl2,d=detail,twist=360*turns,gap=gap,start = 0.05, stop = 0.95);
