...
/* [House] */
//dimensions in cm
housex = rnd(600,2000); //[100:3000]
housey = rnd(housex*0.3,2000); //[100:3000]
housez = rnd(400,500); //[100:3000]
//roof height
roofz = rnd(housez*0.2,housez); //[30:10000]
//export as plate
asplate =0; //[1,0]
//0=everything
...
doorh = rnd(housez*0.5,housez); //[10:500]
doorw = rnd(80,300); //[10:500]
doord = 20; //[10:30]
doorz = 0; //[0:500]
winh = rnd(housez*0.5,housez*0.8); //[10:500]
winw = rnd(doorw,300); //[10:500]
wind = 20; //[10:30]
winz = 82; //[0:500]
//distance from corner to first window
vanpadding = rnd(max(winw,doorw),500); //[0:500]
//spaceing
spacew = rnd(40,500); //[0:500]
...
/* [Walls] */
//brick sizes
stoneh = rnd(20,100); //[10:1000]
stonew = rnd(30,100); //[10:1000]
stoned = rnd(35,40); //[5:50]
bstoneh = rnd(30,doorh*0.2); //[10:1000]
bstonew = stonew; //[10:1000]
bstoned = stoned; //[5:50]
//round wall tiles
stonetypewall = ddice()-1; //[0,1] 
//wall randomnes [0:50)
fr = 20;
/* [Roof] */
// roof over shoot [10:200]
overhang = rnd(10,100);
overhang2 = rnd(10,100);
//rooftile size
roofstoneh = rnd(50,100+housex*(ddice()-1)); //[10:1000]
roofstonew = rnd(50,100); //[10:1000]
roofstoned = rnd(40,50); //[5:50]
//round roof tiles
stonetype = ddice()-1; //[0,1] 
//roof randomness
fr2 = 10;
/* [Chimney] */
//dimensions in cm 
