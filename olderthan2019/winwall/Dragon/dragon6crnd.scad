...
HeadTargetRoll=crnd(0.7);//[-1:0.05:1]
NoseTargetHeight=crnd(1)+1;//[-1:0.05:1]
...
ArmsTargetHeight=-crnd(1)+abs(crnd(ArmsTargetSpan));//crnd(1);//[-1:0.05:1]
...
CThorax = CPelvis + lim33(14,20,[15*ThoraxTargetFront ,FrontFootBase[1]*0.1+10*ThoraxTargetSideShift ,5+5*ArmsTargetHeight+10*ThoraxTargetHeight  ]);
